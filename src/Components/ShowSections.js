...
function ShowSectionComponent(props) {
  const { classes } = props;
  //console.log(props);
    ...
    <div className={classes.root}>
      {buttonArr.map(arrayImageURL => (
        ...
        >
          ...
          <span className={classes.imageButton} onClick={ ()=> {props.gotoShowItemComponent(arrayImageURL.key)}}>
            <Typography
              component="span"
              variant="subtitle1"
              color="inherit"
...
ShowSectionComponent.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(ShowSectionComponent);